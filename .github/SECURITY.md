                      ...
                      - - **Environment Variables**: Sensitive information such as `GEMINI_API_KEY` and the JWT `SECRET_KEY` should ALWAYS be managed via environment variables or a secure secret manager (e.g., AWS Secrets Manager, HashiCorp Vault).
                        - - **Proactive Warnings**: Do not hardcode internal secrets in `auth.py` for production deployments.
                          ...
                          - 1. **Acknowledgment**: We will acknowledge receipt of your report within 48 hours.
                            2. 2. **Investigation**: We will investigate the issue and determine its severity.
                               3. 3. **Fix**: If a vulnerability is confirmed, we will develop a fix and test it thoroughly.
                                  4. 4. **Notification**: We will notify the reporter once the fix is ready for release.
                                     5. 5. **Release**: A new version containing the security fix will be released.
                                        6. 6. **Public Announcement**: After the fix is deployed and verified, a public announcement may be made (with credit to the reporter, if desired).
                                          
                                           7. ---
                                          
                                           8. *Thank you for helping us keep OpenRAG secure!*
                                           9. 
